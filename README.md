...
- A Web app and API server allow users to create subdomains for their own use. The server supports [A Record](https://www.cloudflare.com/learning/dns/dns-records/dns-a-record/) (to map a domain name to an IPv4 address), [AAAA Record](https://www.cloudflare.com/learning/dns/dns-records/dns-aaaa-record/) (to map a domain name to an IPv6 address), [MX Record](https://www.cloudflare.com/learning/dns/dns-records/dns-mx-record/) (to direct emails to a mail server ), and/or [CNAME Record](https://www.cloudflare.com/learning/dns/dns-records/dns-cname-record/) (to provide an alias for an existing domain).
