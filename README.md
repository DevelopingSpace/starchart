...
For information about running Starchart, see our [deployment guide](docs/DEPLOY.md). For development information, see our [contributing guide](docs/CONTRIBUTING.md). For further technical background, planning, and initial designs, please see the [wiki](https://github.com/Seneca-CDOT/starchart/wiki).
